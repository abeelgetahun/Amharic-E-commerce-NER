...
class DataUnifier:
    ...
    def generate_dataset_summary(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'channels': df['channel_username'].unique().tolist(),
            'messages_per_channel': df['channel_username'].value_counts().to_dict(),
            'date_range': {
                'earliest': df['date'].min(),
                'latest': df['date'].max()
            },
            'amharic_messages': df['is_amharic'].sum(),
            'messages_with_media': df['has_media'].sum(),
            'messages_with_price_hints': df['has_price_hints'].sum(),
            'messages_with_location_hints': df['has_location_hints'].sum(),
            'messages_with_product_hints': df['has_product_hints'].sum(),
